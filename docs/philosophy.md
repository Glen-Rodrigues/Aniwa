...
The philosophy behind Aniwa guides:
...
The system should remain easy to:
- extend
- test
- maintain
- contribute to
...
Future versions of Aniwa aim to provide:
...
Aniwa is built as an open-source project because data tooling benefits from:
- transparency
- collaboration
- extensibility
- shared innovation
